...
client.on('message', message => {
	...
	request.get('http://www.ncdc.noaa.gov/cdo-web/api/v2/data?datasetid=GHCND&datatypeid=PRCP&locationid=ZIP:33309&startdate=2018-05-01&enddate=2018-05-23', headers: {Token: 'EVsHKopYoOqeGEVaQXQszifvBJEAfbSg'}, function(err, res, body){
